...
namespace OnlibeLibrary.Services.UnitTests.Concrete_Tests.BookService_Tests
{
    ...
    public class FindTestClass
    {
        ...
        public void Init()
        {
            ...
            {
                new SubCategory { Id = 1, Name = "C# Programming", CategoryId = 1, Category = categories.First(c => c.Id == 1), Books = new List<Book>
                {
                ...
                new SubCategory { Id = 2, Name = "Java Programming", CategoryId = 1, Category = categories.First(c => c.Id == 1), Books = new List<Book>
                {
